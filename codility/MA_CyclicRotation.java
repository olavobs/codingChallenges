...
public class MA_CyclicRotation {

    public static void main(String[] args) {
        System.out.println(Arrays.toString(solution(new int[]{3, 8, 9, 7, 6}, 3)));
        System.out.println(Arrays.toString(solution(new int[]{10, 0, 0}, 5)));
        System.out.println(Arrays.toString(solution(new int[]{1, 2, 3, 4}, 4)));
        System.out.println(Arrays.toString(solution(new int[]{1, 2}, 2)));
        System.out.println(Arrays.toString(solution(new int[]{21}, 20)));
    }
